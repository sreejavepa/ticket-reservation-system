...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `seat_BEFORE_INSERT` BEFORE INSERT ON `seat` FOR EACH ROW BEGIN
...
-- Dump completed on 2023-12-05 22:00:55
